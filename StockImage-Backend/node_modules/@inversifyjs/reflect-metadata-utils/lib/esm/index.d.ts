declare function buildArrayMetadataWithArray<T>(newArrayMetadata: T[]): (arrayMetadata: T[]) => T[];
...
export { buildArrayMetadataWithArray, buildArrayMetadataWithElement, buildArrayMetadataWithIndex, buildEmptyArrayMetadata, buildEmptyMapMetadata, getOwnReflectMetadata, getReflectMetadata, setReflectMetadata, updateOwnReflectMetadata, updateReflectMetadata };
